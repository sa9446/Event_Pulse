    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                // Accept the current "deadair" scheme plus the legacy "bitchat" scheme emitted by
                // pre-rebrand builds, so QR codes generated by older clients still verify.
                val scheme = uri.scheme?.lowercase()
                if ((scheme != "deadair" && scheme != "bitchat") || uri.host != "verify") return null
